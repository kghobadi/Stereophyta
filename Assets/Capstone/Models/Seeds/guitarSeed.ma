...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 17.705486647197894;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D57043D0-406B-A703-B839-F892B23254E8";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "8A64DBF0-49BA-A4CD-9696-F091DA797FD8";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "50A52279-44B6-563A-FFE3-DE881AC61D0C";
createNode displayLayerManager -n "layerManager";
	rename -uid "BD66A1DA-4343-26BD-1936-7B84F9FC51B6";
createNode displayLayer -n "defaultLayer";
	rename -uid "0BA09230-4DD6-3894-DD61-2A9A46F18C8A";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5544A794-4294-134D-65E4-0FBC5F1CD20F";
