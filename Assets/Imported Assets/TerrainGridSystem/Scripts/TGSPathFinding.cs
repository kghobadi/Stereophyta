...
namespace TGS {
	...
	public partial class TerrainGridSystem : MonoBehaviour {
		...
		public List<int> FindPath (int cellIndexStart, int cellIndexEnd, out float totalCost, float maxSearchCost = 0, int maxSteps = 0, int cellGroupMask = -1, bool ignoreStartEndCellCanCrossCheck = false, bool ignoreAnyCellCanCrossCheck = false) {
			totalCost = 0;
			...
			if (cellIndexStart != cellIndexEnd) {
				...
				if (ignoreStartEndCellCanCrossCheck || ignoreAnyCellCanCrossCheck) {
				...
				finder.IgnoreCanCrossCheck = ignoreAnyCellCanCrossCheck;
